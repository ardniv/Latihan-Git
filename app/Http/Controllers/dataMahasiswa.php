...
class dataMahasiswa extends Controller
{
    ...
    public function user()
    {
        ...
        if (request()->ajax()) {
            return response()->json(['pengguna' => $pengguna, 'profil' => $profil]);
        }

        // // Jika bukan AJAX, kembalikan tampilan dengan data yang diperlukan
        return view('data_user', ['pengguna' => $pengguna, 'profil' => $profil]);
    }
